...
const Main = () => {
  return (
    <div className="Main-Content  p-14 md:p-0 md:h-screen bg-black text-white flex flex-col-reverse  md:flex-row items-center
    text-start  md:justify-around px-5 md:px-10 md:gap-5 ">
     ...
     <div className="flex gap-16 justify-center md:justify-start md:gap-10 items-center mt-5">
        <button className="bg-orange-500 p-2 rounded">Explore More</button>
        <button className="ring-1 ring-orange-500 p-2 rounded" >See Products</button>
