...
const Navbar = () => {
  return (
    ...
    <div
        className="absolute -inset-1 bg-gradient-to-r from-red-600 to-violet-600 rounded-lg blur opacity-70 group-hover:opacity-100 transition duration-1000 group-hover:duration-200">
    </div>

    <div className="relative m-0.5 bg-black ring-1 ring-gray-100   rounded-lg leading-none  ">
    
   
    <div className="flex p-1 rounded-3xl lg:rounded-lg justify-around items-center bg-black text-white ">
